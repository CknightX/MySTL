...
namespace CK_STL
{
	class heap_construct
	{
		private:
			...
			static void push_heap(RandomAccessIterator first,Distance hole_index,Distance top_index,T value,const Compare& x)
				{
					...
					while(hole_index > top_index && x(*(first+parent),value))
					{
			...
			template<class RandomAccessIterator,class Distance,class T,class Compare>
				static void adjust_heap(RandomAccessIterator first,Distance hole_index,Distance len,T value,const Compare& x)
				{
					typedef typename iterator_traits<RandomAccessIterator>::value_type value_type;
					typedef typename iterator_traits<RandomAccessIterator>::difference_type difference_type;
					...
					while(second_child<len)
					{
						...
						*(first+hole_index)=value;
						push_heap(first,hole_index,top_index,value,x);

				}
		public:
			template<class RandomAccessIterator,class Compare>
				static void push_heap(RandomAccessIterator first,RandomAccessIterator last,const Compare& x)
				{
					typedef typename iterator_traits<RandomAccessIterator>::value_type value_type;
					typedef typename iterator_traits<RandomAccessIterator>::difference_type difference_type;
			...
			template<class RandomAccessIterator,class Compare>
				static void pop_heap(RandomAccessIterator first,RandomAccessIterator last,const Compare& x)
				{
					typedef typename iterator_traits<RandomAccessIterator>::value_type value_type;
					typedef typename iterator_traits<RandomAccessIterator>::difference_type difference_type;
					value_type value=*(last-1);
					...
					*result=*first;
					adjust_heap(first,hole_index,len-1,value,x);
				}
			...
			template<class RandomAccessIterator,class Compare>
				static void make_heap(RandomAccessIterator first,RandomAccessIterator last,const Compare& x)
				{
					typedef typename iterator_traits<RandomAccessIterator>::value_type value_type;
					typedef typename iterator_traits<RandomAccessIterator>::difference_type difference_type;
					...
					while(true)
					{
						adjust_heap(first,hole_index,len,static_cast<value_type>(*(first+hole_index)),x);
			...
			template<class RandomAccessIterator>
				static inline void make_heap(RandomAccessIterator first,RandomAccessIterator last)
				{
					typedef typename iterator_traits<RandomAccessIterator>::value_type value_type;
